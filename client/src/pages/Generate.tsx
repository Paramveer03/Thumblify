      ...
      <div className="pt-24 min-h-screen">
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-28 lg:pb-8">
          ...
          <div className="grid lg:grid-cols-[400px_1fr] gap-8 items-start">
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg border-white/12 bg-black/20 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-pink-500"
                    />
                    <div>
            ...
            <div className="p-6 rounded-2xl bg-white/8 border border-white/10 shadow-xl self-start">
              <h2>Preview</h2>
              <PreviewPanel
                thumbnail={thumbnail}
                isLoading={loading}
