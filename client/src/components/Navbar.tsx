    ...
    return (
        <>
            ...
            >
               <Link to= '/'>
                ...
                <Link to='/' className="hover:text-pink-300 transition">Home</Link>
                 ...
                 {
                    isLoggedIn ? <Link to='/mygeneration' className="hover:text-pink-300 transition">My Generation</Link>
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                {isLoggedIn? <Link onClick={() => setIsOpen(false)} to='/mygeneration' >My Generation</Link>

                : <Link onClick={() => setIsOpen(false)} to='#' >About</Link>
                }
                <Link onClick={() => setIsOpen(false)} to='/mygeneration' >My Generation</Link>
